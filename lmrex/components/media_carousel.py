...
def media_carousel(media_items):
    return (
        (
            rx.vstack(
                rx.heading(["title"], size="9", text_align="center"),
                rx.badge(
                    ["type"],
                    color_scheme=rx.cond(
                        ["type"] == "red",
                        "red",
                        rx.cond(["type"] == "purple", "purple", "blue"),
                    ),
                    size="2",
                ),
    ...
    rx.box(
        ...
        rx.hstack(
            ...
            rx.button(
                ...
                variant="outline",
                size="3",
                disabled=State.media_count == State.current_media_item,
                style={
                    "min_width": "100px",
                },
            ),
