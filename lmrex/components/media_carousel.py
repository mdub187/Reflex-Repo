...
def media_carousel(current_media_item):
    ...
    rx.container(
        rx.vstack(
            ...
            rx.vstack(
                rx.heading(
                MediaState.MediaService.get_default_media_items["title"], size="9", text_align="center"
                ),
                rx.badge(
            ...
            rx.box(
                rx.cond(
                    MediaState.MediaService.get_default_media_items["type"] == "video",
                    ...
                    rx.image(
                        src=MediaState.MediaService.current_media_item["url"],
                        width="100%",
                        height="100%",
                        object_fit="contain",
                        style={
